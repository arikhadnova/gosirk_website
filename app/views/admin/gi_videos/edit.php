    ...
    <div class="card border-0 shadow-sm rounded-4" style="max-width: 640px;">
        ...
        <div class="card-body p-4">
            <div class="mb-4">
                ...
                <input type="url" name="url" id="yt_url" class="form-control" placeholder="https://www.youtube.com/watch?v=..." value="<?= $video->url; ?>" <?= FormRules::attrs('gi_video', 'url', 'update') ?>>
            </div>
            <div class="mb-4">
                <label class="form-label fw-bold small text-dark">Thumbnail Custom <span class="text-muted fw-normal">(Opsional)</span></label>
                <?php if ($video->thumbnail) : ?>
                    <div class="mb-2">
                        <img src="<?= ASSETS_URL; ?>img/gi/videos/<?= $video->thumbnail; ?>" class="img-fluid rounded-3 border" style="max-width: 280px;">
                    </div>
                <?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="order_priority" class="form-control" value="<?= $video->order_priority; ?>" style="max-width: 160px;" <?= FormRules::attrs('gi_video', 'order_priority', 'update') ?>>
            </div>
